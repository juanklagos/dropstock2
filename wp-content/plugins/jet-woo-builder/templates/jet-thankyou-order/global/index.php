...
$order_thankyou_message = ! empty( $settings['thankyou_message_text'] ) ? esc_html__( $settings['thankyou_message_text'], 'jet-woo-builder' ) : esc_html__( 'Thank you. Your order has been received.', 'woocommerce' );
