...
class Jet_Woo_Builder_Products_Loop extends Jet_Woo_Builder_Base {
	...
	protected function _register_controls() {
		...
		$templates         = jet_woo_builder_post_type()->get_templates_list_for_options( 'archive' );
		...
		$this->start_controls_section(
			'section_general',
			array(
				'label' => esc_html__( 'Switcher', 'jet-woo-builder' ),
			)
		);
	...
	/**
	 * Define default archive template from main layout
