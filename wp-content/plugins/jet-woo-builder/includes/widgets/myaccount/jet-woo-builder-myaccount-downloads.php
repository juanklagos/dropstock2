...
class Jet_Woo_Builder_MyAccount_Downloads extends Jet_Woo_Builder_Base {
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			...
			array(
				'heading' => '.woocommerce-table--order-downloads thead th',
				'cell'    => '.woocommerce-table--order-downloads tbody tr td',
				'button'  => '.download-file a.woocommerce-MyAccount-downloads-file',
			)
		);
