	...
	class Jet_Woo_Builder_Popup_Package {
		...
		public function register_controls( $manager ) {
			...
			$manager->add_control(
				...
				array(
					'label'        => esc_html__( 'JetWooBuilder Cart Popup', 'jet-woo-builder' ),
		...
		public function get_popup_content( $content, $popup_data ) {
			...
			$content = apply_filters( 'jet-woo-builder/compatibility/popup-package/the_content', $content, $popup_data );
