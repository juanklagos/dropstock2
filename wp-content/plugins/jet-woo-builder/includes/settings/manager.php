...
class Settings {
	...
	public function __construct() {
		...
		$this->subpage_modules = apply_filters( 'jet-woo-builder/settings/registered-subpage-modules', array(
			'jet-woo-builder-general-settings' => array(
				'class' => '\\Jet_Woo_Builder\\Settings\\General',
				'args'  => array(),
			),
			'jet-woo-builder-avaliable-addons' => array(
				'class' => '\\Jet_Woo_Builder\\Settings\\Avaliable_Addons',
				'args'  => array(),
			),
		) );
	...
	public function init_plugin_subpage_modules() {
		...
		require jet_woo_builder()->plugin_path( 'includes/settings/subpage-modules/avaliable-addons.php' );
