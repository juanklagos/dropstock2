...
class General extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-woo-builder-general-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'General Settings', 'jet-woo-builder' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-woo-builder-general-settings'] = jet_woo_builder()->plugin_path( 'templates/admin-templates/general-settings.php' );
