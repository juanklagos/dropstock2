...
class Module extends Page_Module_Base {
	...
	public function modify_item_styles() {
		...
		$inline_admin_styles = file_get_contents( Dashboard::get_instance()->get_dashboard_url() . 'assets/css/jet-dashboard-admin-inline.css' );

		echo sprintf( '<style type="text/css">%s</style>', $inline_admin_styles);
	}
