...
class BMEAPI {
     ...
     */
    function BMEAPI($api_key, $apiURL = 'https://api.benchmarkemail.com/1.3/' ) {
        $this->apiUrl = $apiURL;
  ...
  /**
    ...
    */
    ...
    function invokeMethod($method, $params) {
        ...
        $client = new IXR_Client( $this->apiUrl, false, 443, $this->timeout );
        $args = func_get_args();

        call_user_func_array( array( $client, 'query' ), $params );
        $response = $client->getResponse();

        if(isset($response['faultCode'])) {
            $response = array("error" => "Error : " . $response['faultString'], "code" => "-2");
        }
...
/**
   ...
   * @example bmeapi_autoresponderGetList.php
    ...
    */
    ...
    {
      $params = array("autoresponderGetList", $filter, $pageNumber, $pageSize, $orderBy, $sortOrder);
...
/**
    ...
    */
    function listAddContactsOptin($listID, $contacts, $optin = "0") {
      $params = array("listAddContactsOptin", $this->apiToken, $listID, $contacts, $optin);
      return $this->invokeMethod("listAddContacts", $params);
    }
    ...
    */
    function listGet($filter, $pageNumber, $pageSize, $orderBy, $sortOrder) {
      $params = array("listGet", $this->apiToken, $filter, $pageNumber, $pageSize, $orderBy, $sortOrder);
