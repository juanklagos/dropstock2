...
class Widget_Featured_Products extends \Elementor\Widget_Base {
	public function get_name() {
		return 'dhwc_elementor_featured_products';
	}
	
	public function get_title() {
		return __( 'WC Featured Products', 'dhwc_elementor' );
	}
	...
	protected function render() {
		...
		echo  \WC_Shortcodes::featured_products([
			'per_page' => $per_page,
			'columns' => $columns,
			'orderby' => $orderby,
			'order' => $order
