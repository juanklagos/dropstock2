...
class Widget_Best_Selling_Products extends \Elementor\Widget_Base {
	
	public function get_name() {
		return 'dhwc_elementor_best_selling_products';
	}
	
	public function get_title() {
		return __( 'WC Best Selling Products', 'dhwc_elementor' );
	}
