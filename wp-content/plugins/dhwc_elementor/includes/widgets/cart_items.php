...
class Widget_Cart_Items extends \Elementor\Widget_Base {
	
	public function get_name() {
		return 'dhwc_elementor_cart_items';
	}
	
	public function get_title() {
		return __( 'WC Cart Items', 'dhwc_elementor' );
	}
	...
	protected function render(){
		...
		echo dhwc_elementor_cart_form_wrap(ob_get_clean(),'woocommerce-cart-form');
	}
}