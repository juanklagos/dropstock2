...
class Widget_Single_Product_Description extends Widget_Single_Product_Base {
	public function get_name() {
		return 'dhwc_elementor_single_product_description';
	}
	
	public function get_title() {
		return __( 'WC Single Product Description', 'dhwc_elementor' );
	}
