...
class Widget_Recent_Products extends \Elementor\Widget_Base {
	public function get_name() {
		return 'dhwc_elementor_recent_products';
	}
	
	public function get_title() {
		return __( 'WC Recent Products', 'dhwc_elementor' );
	}
	...
	protected function render() {
		...
		echo \WC_Shortcodes::recent_products([
			'per_page' => $per_page,
			'columns' => $columns,
			'orderby' => $orderby,
			'order' => $order
