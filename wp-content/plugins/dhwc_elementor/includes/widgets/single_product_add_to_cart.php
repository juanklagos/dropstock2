...
class Widget_Single_Product_Add_to_Cart extends Widget_Single_Product_Base {
	public function get_name() {
		return 'dhwc_elementor_single_product_add_to_cart';
	}
	
	public function get_title() {
		return __( 'WC Single Product Add to Cart', 'dhwc_elementor' );
	}
