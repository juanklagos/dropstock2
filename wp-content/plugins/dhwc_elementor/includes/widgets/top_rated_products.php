...
class Widget_Top_Rated_Products extends \Elementor\Widget_Base {
	public function get_name() {
		return 'dhwc_elementor_top_rated_products';
	}
	
	public function get_title() {
		return __( 'WC Top Rated Products', 'dhwc_elementor' );
	}
	...
	protected function render() {
		...
		echo \WC_Shortcodes::top_rated_products([
			'per_page' => $per_page,
			'columns' => $columns,
			'orderby' => $orderby,
			'order' => $order
